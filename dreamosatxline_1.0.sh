...
echo -e "${CYAN}"
echo "################################################################"
echo "#     Start downloading and installing  dreamosatxline_1.0     #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1303/refs/heads/main/enigma2-plugin-extensions-dreamosatxline_1.0_all.ipk"
IPK_NAME="enigma2-plugin-extensions-dreamosatxline_1.0_all.ipk"
