...
echo -e "${CYAN}"
echo "################################################################"
echo "#    Start downloading and installing  dreamosatxsignal_2.0    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1303/refs/heads/main/enigma2-plugin-extensions-dreamosatxsignal_2.0_all.ipk"
IPK_NAME="enigma2-plugin-extensions-dreamosatxsignal_2.0_all.ipk"
